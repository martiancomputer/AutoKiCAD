...
private:
    ...
    handleRunTransmissionLineCalculation(
            const HANDLER_CONTEXT<commands::RunTransmissionLineCalculation>& aCtx );

    HANDLER_RESULT<commands::ListLibrariesResponse> handleListLibraries(
            const HANDLER_CONTEXT<commands::ListLibraries>& aCtx );
