...
private:
    ...
    HANDLER_RESULT<kiapi::schematic::types::PlaceSymbolResponse>
    handlePlaceSymbol( const HANDLER_CONTEXT<kiapi::schematic::types::PlaceSymbol>& aCtx );

    HANDLER_RESULT<kiapi::schematic::types::SearchSymbolsResponse>
    handleSearchSymbols( const HANDLER_CONTEXT<kiapi::schematic::types::SearchSymbols>& aCtx );

    HANDLER_RESULT<kiapi::schematic::types::RunErcResponse>
    handleRunErc( const HANDLER_CONTEXT<kiapi::schematic::types::RunErc>& aCtx );
