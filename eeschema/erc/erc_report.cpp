...
RC_JSON::ERC_REPORT ERC_REPORT::BuildReport() const
{
...
{
    // Report construction lives in BuildReport() so the API and
    // `kicad-cli sch erc --format json` cannot drift apart.
    RC_JSON::ERC_REPORT reportHead = BuildReport();
